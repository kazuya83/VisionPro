...
const setNavigationContainaer = () => {
    ...
    const res = postConnect({}, 'get_navigation_list');
    ...
    navigationList.forEach(navigation => {
        ...
        siwtchBtn.addEventListener('click', () => {
            ...
            const res = postConnect({ navigation_id: navigation.navigation_id, next_is_deleted: nextIsDeleted }, 'update_navigation_is_deleted')
            setNavigationContainaer();
        });
